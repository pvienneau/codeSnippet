...
<div id="update_sidebar">
	<ul class="sidebar" id="<?php echo $invoice->id; ?>">
		<li><a href="#" id="send">Send Invoice</a></li>
		<li><a href="invoice/download/<?php echo $invoice->id; ?>" id="download">Download PDF</a></li>
		<li><a href="#" id="payment">Add Payment</a></li>
		<li><a href="#" id="history">View History</a></li>
		<li><a href="public/invoice/<?php echo $invoice->permalink; ?>" class="blank" id="permalink">Permalink</a></li>
		<li><a href="invoice/edit/<?php echo $invoice->id; ?>" id="edit">Edit Invoice</a></li>
		<li><a href="#" id="remove">Remove Invoice</a></li>
	</ul>
</div>
<?php endif; ?>
	...
	<div class="dialog" id="payment_dialog" style="display: none">
		<form action="invoice/payment/<?php echo $invoice->id; ?>" method="post">
			...
			<div class="selection">
				...
				<div id="description">
					<label style="width:100%">Description</label><br />
			...
			<div class="control">
				<input type="submit" class="button" id="add_payment" value="Add Payment" />
				<a class="small_button">Cancel</a>
			</div>
...
<?php if (strpos($history->event, 'Payment') !== false): ?>
			<a id="<?php echo $history->id; ?>" class="remove_payment" href="#">Remove this payment</a>
<?php endif; ?>
		</div>
<?php endforeach; ?>
...
<div id="details">
	...
	<div class="left">
		...
		<?php if($recurring = RecurringHistory::ofInvoice($invoice->id) && (AuthUser::accessLevel("recurrings") > 0)):?>
			<p><a href="recurring/view/<?php echo $recurring->recurring_id;?>">Recurring invoice</a></p>
		<?php endif; ?>
	</div>
	...
	<div class="right invoice_text_light">
		...
		<p><?php echo my_date_format($invoice->due_date); ?> (<?php echo $invoice->due; ?> days)</p>
	</div>
...
<?php endforeach; ?>
	...
	<div id="subtotal">
		<div class="left">
		<?php if ($invoice->management) echo "<p>Project Management ({$invoice->management}%)</p>"; ?>
...
<div class="invoice_text_light" id="invoice_foot">This account is payable upon reception of this invoice. After 30 days, an interest of 1.5% per month (18% per year) will be added to any unpaid balance.</div>

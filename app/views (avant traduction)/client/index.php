...
<?php if(AuthUser::accessLevel("clients") > 1): ?>
	...
	<ul class="sidebar">
		<li><a href="#" id="new">New Client</a></li>
	</ul>
<?php endif; ?>
...
<span class="company"><em><?php echo $client->company; ?></em>
	...
	<?php endif; ?>
	<a href="http://maps.google.com/maps?f=q&hl=en&geocode=&q=<?php echo urlencode($client->address_line_1.' '.$client->address_line_2.' '.$client->city.' '.$client->state.' '.$client->zip_code.' '.$client->country); ?>" class="blank">Google Map</a>

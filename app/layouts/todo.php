<?php $ctrl = Dispatcher::getController(); ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="head">
	...
	<div id="nav"><ul>
		<li<?php if ($ctrl == 'project') echo ' class="current"'; ?>><a href="project/dashboard">dashboard</a></li>
		<li<?php if ($ctrl == 'todo') echo ' class="current"'; ?>><a href="todo">to-do</a></li>
		<li<?php if ($ctrl == 'milestone') echo ' class="current"'; ?>><a href="milestone">milestone</a></li>
		<li<?php if ($ctrl == 'file') echo ' class="current"'; ?>><a href="file">file</a></li>

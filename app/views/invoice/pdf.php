...
<table class="layout">
	<tr>
		<td class="one"><img src="<?php echo dirname(__FILE__); ?>/small-carbure.jpg" /></td>
		<td class="two">
			<h1><?php echo mb_strtoupper(__('Invoice'), 'UTF-8'); ?></h1>
			<h2><?php echo mb_strtoupper($invoice->project_name, 'UTF-8'); ?></h2>
		</td>
	</tr>
	<tr>
		<td class="one">
			...
			<b><?php echo mb_strtoupper(__('Invoice ID'), 'UTF-8'); ?></b><br />
			<?php echo $invoice->invoice_id; ?><br />
			<br />
			
			<b><?php echo mb_strtoupper(__('Date Of Invoice'), 'UTF-8'); ?></b><br />
			<?php echo mb_strtoupper(my_date_format($invoice->date), 'UTF-8'); ?><br />
			<br />
			
			<b><?php echo mb_strtoupper(__('Payment Is Due'), 'UTF-8'); ?></b><br />
			<?php echo mb_strtoupper(my_date_format($invoice->due_date), 'UTF-8'); ?> (<?php echo $invoice->due .' '. mb_strtoupper(__('days')); ?>)<br />
			<br />
		...
		<td class="two">
			...
			<?php if ($invoice->management): ?>
				<tr>
					<td><?php echo mb_strtoupper(__('Project Management'), 'UTF-8'); ?> (<?php echo $invoice->management; ?>%)</td>
					<td class="right"><?php echo my_number_format($invoice->management_fee); ?> $</td>
				</tr>
			<?php endif; ?>
			<?php if ($invoice->subtotal != $invoice->total): ?>
				<tr class="subtotal">
					<td><?php echo mb_strtoupper(__('Subtotal'), 'UTF-8'); ?></td>
					<td class="right"><?php echo my_number_format($invoice->subtotal); ?> $</td>
				</tr>
				<?php if ($invoice->discount): ?>
				<tr>
					<td><?php echo mb_strtoupper(__('Discount'), 'UTF-8'); ?></td>
					<td class="right"><?php echo my_number_format($invoice->dicount_fee); ?> $</td>
				</tr>
				<?php endif; ?>
				<?php if ($invoice->tax): ?>
				<tr>
					<td><?php echo mb_strtoupper($invoice->tax_name, 'UTF-8') . ' ('.$invoice->tax.'%)'; ?></td>
					<td class="right"><?php echo my_number_format($invoice->tax_fee); ?> $</td>
				</tr>
				<?php endif; ?>
				<?php if ($invoice->tax2): ?>
				<tr>
					<td><?php echo mb_strtoupper($invoice->tax2_name, 'UTF-8') . ' ('.$invoice->tax2.'%)'; ?></td>
					<td class="right"><?php echo my_number_format($invoice->tax2_fee); ?> $</td>
				</tr>
				<?php endif; ?>
				<?php if ($invoice->shipping): ?>
				<tr>
					<td><?php echo mb_strtoupper(__('Shipping'), 'UTF-8'); ?></td>
					<td class="right"><?php echo my_number_format($invoice->shipping); ?> $</td>
				</tr>
				<?php endif; ?>
			<?php endif; ?>
			</table>
			<table>
				<tr class="total">
					<td><h1><?php echo mb_strtoupper(__('Total'), 'UTF-8'); ?></h1></td>
					<td class="right"><h1><?php echo my_number_format($invoice->total); ?> $</h1></td>
				</tr>
			</table>
			<table class="foot">
				<?php if ($invoice->paid): ?>
				<tr>
					<td><?php echo mb_strtoupper(__('Paid'), 'UTF-8'); ?></td>
					<td class="right"><?php echo my_number_format($invoice->paid); ?> $</td>
				</tr>
				<?php endif; ?>
				<?php if ($invoice->paid && $invoice->paid < $invoice->total): ?>
				<tr>
					<td><?php echo mb_strtoupper(__('Balance Due'), 'UTF-8'); ?></td>
					<td class="right"><?php echo my_number_format($invoice->balance_due); ?> $</td>
				</tr>
				<?php endif; ?>
			</table>
			...
			<div class="notes">
				...
				<?php echo mb_strtoupper(nl2br($invoice->notes), 'UTF-8'); ?>
			</div>
			<?php endif; ?>

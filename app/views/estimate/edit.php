...
<h3 class="title"><?php echo __('Edit Estimate');?></h3>
...
<div class="inline" >
	<label class="id"><?php echo __('Estimate ID');?></label>
...
<div class="inline">
	...
	<div class="select_wrapper">
		<select name="status" class="select">
			<option value="draft"<?php is_selected($estimate->status == 'draft'); ?>><?php echo __('Draft');?></option>
			<option value="sent"<?php is_selected($estimate->status == 'sent'); ?>><?php echo __('Sent');?></option>
			<option value="accepted"<?php is_selected($estimate->status == 'accepted'); ?>><?php echo __('Accepted');?></option>
			<option value="refused"<?php is_selected($estimate->status == 'refused'); ?>><?php echo __('Refused');?></option>
			<option value="invoiced"<?php is_selected($estimate->status == 'invoiced'); ?>><?php echo __('Invoiced');?></option>
		</select>
	</div>
</div>
...
<div id="subtotal">
	...
	<div class="left">
		<p class="management_display"<?php echo is_display($estimate->management); ?>><?php echo __('Project Management');?><span id="management_rate"></span></p>
		<p class="subtotal_display"<?php echo is_display($estimate->subtotal != $estimate->total); ?>><?php echo __('Subtotal');?></p>
		<p class="discount_display"<?php echo is_display($estimate->discount); ?>><?php echo __('Discount');?><span id="discount_rate"></span></p>
...
<?php foreach($options as $index => $option): ?>
		<li class="option">
			<a href="#" class="remove_option"><?php echo __('Remove Option');?></a>
			...
			<div class="select_wrapper">
				<select name="option[<?php echo $index; ?>][kind]" class="select">
					<option value="hour"<?php echo is_selected($option->kind == 'hour'); ?>><?php echo __('hour');?></option>
					<option value="day"<?php echo is_selected($option->kind == 'day'); ?>><?php echo __('day');?></option>
					<option value="service"<?php echo is_selected($option->kind == 'service'); ?>><?php echo __('service');?></option>
					<option value="product"<?php echo is_selected($option->kind == 'product'); ?>><?php echo __('product');?></option>
				</select>
			</div>
...
<?php endforeach; ?>
	...
	<a href="#" id="insert_option"><?php echo __('Insert');?></a>

	<ul class="menu" id="insert_option_menu" style="display: none">
		<li><a href="#" id="insert_new_option"><?php echo __('Insert New Option');?></a></li>
		<!--li><a href="#" id="insert_project">Insert From Projects…</a></li-->
		<li><a href="#" id="insert_option_item"><?php echo __('Insert From Items');?>…</a></li>
	</ul>

</div><!-- end #option_part -->
<input type="submit" class="button" id="add_estimate" value="<?php echo __('Save Changes');?>" />

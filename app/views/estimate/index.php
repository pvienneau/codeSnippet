...
<h3 class="title"><?php echo __('New Estimate');?></h3>
...
<form action="estimate/add" method="post">
	...
	<div class="inline none">
		<a href="#" id="invoice_settings"><?php echo __('Estimate Settings');?></a>
	</div>
...
<?php endforeach; ?>
	...
	<div class="inline none">
		<a href="#" id="estimate_option"><?php echo __('Estimate Options');?></a>
	</div>
	...
	<input type="submit" class="button" id="add_estimate" value="<?php echo __('Add Estimate');?>" />
...
<ul class="sidebar">
	<li><a href="#" id="new"><?php echo __('New Estimate');?></a></li>
</ul>
<?php endif; ?>
<h3 class="title"><?php echo __('Estimates');?></h3>
		...
		<form action="estimate" method="post">
			...
			<div class="select_wrapper">
				<select name="status" class="select">
					...
					<option value="refused"><?php echo __('Refused');?></option>
					<option value="invoiced"><?php echo __('Invoiced');?></option>
				</select>
			</div>
		</form>
	</li>
	...
	<li class="row" id="<?php echo $estimate->id; ?>">
		<?php if(AuthUser::accessLevel("estimates") > 1): ?>
			<span class="actions" style="display: none">
				...
				<a href="estimate/edit/<?php echo $estimate->id; ?>" class="edit"><?php echo __('Edit');?></a>
			</span>
		<?php endif; ?>
		<span class="id"><a href="estimate/view/<?php echo $estimate->id; ?>"><?php echo $estimate->estimate_id; ?></a></span>
<?php if ($estimate->invoiced) : ?>
		<span class="date">&#x2192; <a href="invoice/view/<?php echo $estimate->invoiced; ?>"><?php echo __('Invoiced');?></a></span>
<?php else: ?>
...
<?php endif; ?>
		...
		<span class="status <?php echo $estimate->status; ?>"><?php echo __(ucfirst($estimate->status)); ?></span>

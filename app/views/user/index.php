...
<li>
<a href="#" id="cancel"><?php echo __('Cancel');?></a>
</li>

</ul>

<h3 class="title"><?php echo __('New User');?></h3>
...
<ul class="sidebar">
	<li><a href="#" id="new"><?php echo __('New User');?></a></li>
</ul>
<?php endif; ?>	
<h3 class="title"><?php echo __('Users');?></h3>
...
<li id="bar">
	...
	<span class="last_login"><?php echo __('Last Login');?></span>
</li>
...
<span class="actions" style="display: none">
	<a href="#" class="remove"><?php echo __('Remove');?></a><a href="user/edit/<?php echo $user->id; ?>" class="edit"><?php echo __('Edit');?></a>
</span>
<?php endif; ?>
<span class="name">
	<?php echo $user->image(); ?>
	...
	<?php if ($user->is_admin): ?>
		<span class="admin"><?php echo __('Admin');?></span>
	<?php endif; ?>
	<?php if (!$user->is_active): ?>
		<span class="inactive"><?php echo __('Inactive');?></span>
	<?php endif; ?>
